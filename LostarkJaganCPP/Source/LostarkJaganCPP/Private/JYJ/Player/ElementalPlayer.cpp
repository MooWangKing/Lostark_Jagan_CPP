...
AElementalPlayer::AElementalPlayer()
{
	...
	// PlayerMesh Settings
	ConstructorHelpers::FObjectFinder<USkeletalMesh> playermesh( TEXT( "/Script/Engine.SkeletalMesh'/Game/ParagonSerath/Characters/Heroes/Serath/Meshes/Serath.Serath'" ) );
